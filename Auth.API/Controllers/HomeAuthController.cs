...
{
        // Ignora este controller na documentação do Swagger
    ...
    public class HomeAuthController : Controller
    {
        ...
        {
            string serviceName = "Microserviço de Autenticação (Auth.API)";
            ...
            string htmlContent = $@"
                ...
                <body>
                    <div class='container'>
                        ...
                        <p>Acesse a documentação interativa para gerar tokens de acesso.</p>
